...
set -g status-bg $mygrey
set -g status-fg $myblue
set -g status-position top

set -g status-left ' #[]#{session_name} #[fg='$myblack']\ '
set -g status-left-length "45"
set -g status-left-style fg=$myblue,bg=$mygrey,bold

set -g status-right '%H:%M %d-%b-%y #[]#{pane_title} '
set -g status-right-length "100"
set -g status-right-style bg=$mygrey,fg=$myblue,bold
...
set-window-option -g window-status-current-bg $myblack
set-window-option -g window-status-current-format " #[bold]#I:#W>#D "

# pane border colors
set-window-option -g pane-border-fg $myblack
set-window-option -ag pane-border-bg $myblack
set-window-option -ag pane-border-style bold

set-window-option -ag pane-active-border-fg $mygrey
set-window-option -ag pane-active-border-bg $myblack
set-window-option -ag pane-active-border-style bold
